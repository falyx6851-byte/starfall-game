...
payload={'glb':base64.b64encode((R/'assets/Stargazer_M03.glb').read_bytes()).decode(),'floor':'data:image/png;base64,'+base64.b64encode((R/'assets/arena.png').read_bytes()).decode(),'hash':hashlib.sha256((R/'assets/Stargazer_M03.glb').read_bytes()).hexdigest()}
...
(R/'Stargazer_M03_PREVIEW.html').write_text(html)
